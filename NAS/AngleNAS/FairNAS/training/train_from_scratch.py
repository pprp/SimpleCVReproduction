...
parser.add_argument('--local_rank', type=int, default=None,
                    help='local rank for distributed training')  # TODO 1
...
parser.add_argument('--gpu', type=int, default=0, help='gpu device id') # TODO
...
parser.add_argument('--model_id', type=str,
                    default='4 2 4 2 2 2 5 2 4 4 2 2 2 4 5 4 2 2 5', help='model_id')
...
def main():
    if not torch.cuda.is_available():
        ...
        sys.exit(1)
    num_gpus = torch.cuda.device_count() # TODO 2
    np.random.seed(args.seed)
    args.gpu = args.local_rank % num_gpus # TODO 3
    torch.cuda.set_device(args.gpu) # TODO 4
    ...
    torch.distributed.init_process_group(backend='nccl', init_method='env://') # TODO 5
    args.world_size = torch.distributed.get_world_size() # TODO 6
    args.batch_size = args.batch_size // args.world_size # TODO 7
    ...
    model = apex.parallel.DistributedDataParallel(model, delay_allreduce=True) # TODO 
    ...
    train_loader = get_train_dataloader(
        args.train_dir, args.batch_size, args.local_rank, args.total_iters) # TODO 
    ...
    while iters < args.total_iters:
        ...
        if args.local_rank == 0: # TODO infer
            valid_acc_top1, valid_acc_top5 = infer(
                val_dataprovider, model.module, val_iters)
...
def train(iters, train_dataprovider, model, criterion, optimizer, train_iters, scheduler):
    ...
    for i in range(train_iters):
        ...
        loss_reduce = reduce_tensor(loss, 0, args.world_size) #  TODO 
        ...
        iters += 1
        if i % args.report_freq == 0 and args.local_rank == 0: # TODO 
