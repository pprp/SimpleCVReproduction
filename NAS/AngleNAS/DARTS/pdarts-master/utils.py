...
from noris_dataset import ImageNetdst
import cv2
import random
import math
...
def get_train_dataloader(train_dir, batch_size, local_rank, total_iters):
    eigvec = np.array([
    ...
    train_dataset = ImageNetdst('/data/Dataset/ImageNet2012/imagenet.train.nori.list',
        transforms.Compose([
...
def get_val_dataloader(val_dir):
    val_dataset = ImageNetdst('/data/Dataset/ImageNet2012/imagenet.val.nori.list', 
        transforms.Compose([
                OpencvResize(256),
